...
package koloneyv1connect

import (
	context "context"
	errors "errors"
	connect_go "github.com/bufbuild/connect-go"
	v1 "koloney-protos/go/v1/koloney/koloney/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	KoloneyServiceName = "koloney.koloney.v1.KoloneyService"
)
...
const (
	...
	// RPC.
	KoloneyServiceGetBalanceProcedure = "/koloney.koloney.v1.KoloneyService/GetBalance"
)

// KoloneyServiceClient is a client for the koloney.koloney.v1.KoloneyService service.
...
// NewKoloneyServiceClient constructs a client for the koloney.koloney.v1.KoloneyService service. By
...
// GetBalance calls koloney.koloney.v1.KoloneyService.GetBalance.
func (c *koloneyServiceClient) GetBalance(ctx context.Context, req *connect_go.Request[v1.GetBalanceRequest]) (*connect_go.Response[v1.GetBalanceResponse], error) {
	return c.getBalance.CallUnary(ctx, req)
}

// KoloneyServiceHandler is an implementation of the koloney.koloney.v1.KoloneyService service.
...
func NewKoloneyServiceHandler(svc KoloneyServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.koloney.v1.KoloneyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedKoloneyServiceHandler) GetBalance(context.Context, *connect_go.Request[v1.GetBalanceRequest]) (*connect_go.Response[v1.GetBalanceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.koloney.v1.KoloneyService.GetBalance is not implemented"))
}
