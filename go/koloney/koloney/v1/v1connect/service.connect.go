...
const (
	...
	KoloneyServiceName = "koloney.koloney.KoloneyService"
)
...
const (
	...
	// RPC.
	KoloneyServiceGetBalanceProcedure = "/koloney.koloney.KoloneyService/GetBalance"
)

// KoloneyServiceClient is a client for the koloney.koloney.KoloneyService service.
...
// NewKoloneyServiceClient constructs a client for the koloney.koloney.KoloneyService service. By
...
// GetBalance calls koloney.koloney.KoloneyService.GetBalance.
...
// KoloneyServiceHandler is an implementation of the koloney.koloney.KoloneyService service.
...
func NewKoloneyServiceHandler(svc KoloneyServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.koloney.KoloneyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedKoloneyServiceHandler) GetBalance(context.Context, *connect_go.Request[v1.GetBalanceRequest]) (*connect_go.Response[v1.GetBalanceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.koloney.KoloneyService.GetBalance is not implemented"))
}
