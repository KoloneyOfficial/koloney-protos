...
func (c *companyServiceClient) VerifyCompany(ctx context.Context, in *VerifyCompanyRequest, opts ...grpc.CallOption) (*VerifyCompanyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCompanyServiceServer) UpdateCompanyStatus(context.Context, *UpdateCompanyStatusRequest) (*UpdateCompanyStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCompanyStatus not implemented")
}
func (UnimplementedCompanyServiceServer) VerifyCompany(context.Context, *VerifyCompanyRequest) (*VerifyCompanyResponse, error) {
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "koloney/company/v1/service.proto",
}
