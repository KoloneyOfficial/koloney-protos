...
const (
	...
	UserServiceName = "koloney.user.UserService"
)
...
const (
	...
	UserServiceCreateUserProcedure = "/koloney.user.UserService/CreateUser"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/koloney.user.UserService/GetUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/koloney.user.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/koloney.user.UserService/DeleteUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/koloney.user.UserService/ListUsers"
	// UserServiceAuthenticateUserProcedure is the fully-qualified name of the UserService's
	// AuthenticateUser RPC.
	UserServiceAuthenticateUserProcedure = "/koloney.user.UserService/AuthenticateUser"
)

// UserServiceClient is a client for the koloney.user.UserService service.
...
// NewUserServiceClient constructs a client for the koloney.user.UserService service. By default, it
...
// CreateUser calls koloney.user.UserService.CreateUser.
...
// GetUser calls koloney.user.UserService.GetUser.
...
// UpdateUser calls koloney.user.UserService.UpdateUser.
...
// DeleteUser calls koloney.user.UserService.DeleteUser.
...
// ListUsers calls koloney.user.UserService.ListUsers.
...
// AuthenticateUser calls koloney.user.UserService.AuthenticateUser.
...
// UserServiceHandler is an implementation of the koloney.user.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.user.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect_go.Request[v1.CreateUserRequest]) (*connect_go.Response[v1.CreateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect_go.Request[v1.GetUserRequest]) (*connect_go.Response[v1.GetUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.UpdateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect_go.Request[v1.DeleteUserRequest]) (*connect_go.Response[v1.DeleteUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.DeleteUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect_go.Request[v1.ListUsersRequest]) (*connect_go.Response[v1.ListUsersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) AuthenticateUser(context.Context, *connect_go.Request[v1.AuthenticateUserRequest]) (*connect_go.Response[v1.AuthenticateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.user.UserService.AuthenticateUser is not implemented"))
}
