...
import (
	...
	koloney "koloney-protos/go/v1/v1/koloney"
	http "net/http"
	strings "strings"
)
...
const (
	...
	KoloneyServiceName = "koloney.v1.koloney.KoloneyService"
)
...
const (
	...
	// RPC.
	KoloneyServiceGetBalanceProcedure = "/koloney.v1.koloney.KoloneyService/GetBalance"
)

// KoloneyServiceClient is a client for the koloney.v1.koloney.KoloneyService service.
...
// NewKoloneyServiceClient constructs a client for the koloney.v1.koloney.KoloneyService service. By
...
// GetBalance calls koloney.v1.koloney.KoloneyService.GetBalance.
...
// KoloneyServiceHandler is an implementation of the koloney.v1.koloney.KoloneyService service.
...
func NewKoloneyServiceHandler(svc KoloneyServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.v1.koloney.KoloneyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedKoloneyServiceHandler) GetBalance(context.Context, *connect_go.Request[koloney.GetBalanceRequest]) (*connect_go.Response[koloney.GetBalanceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.koloney.KoloneyService.GetBalance is not implemented"))
}
