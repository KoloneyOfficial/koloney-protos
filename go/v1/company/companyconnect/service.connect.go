...
import (
	...
	company "koloney-protos/go/v1/v1/company"
	http "net/http"
	strings "strings"
)
...
const (
	...
	CompanyServiceName = "koloney.v1.company.CompanyService"
)
...
const (
	...
	// CreateCompany RPC.
	CompanyServiceCreateCompanyProcedure = "/koloney.v1.company.CompanyService/CreateCompany"
	// CompanyServiceGetCompanyProcedure is the fully-qualified name of the CompanyService's GetCompany
	// RPC.
	CompanyServiceGetCompanyProcedure = "/koloney.v1.company.CompanyService/GetCompany"
	// CompanyServiceUpdateCompanyProcedure is the fully-qualified name of the CompanyService's
	// UpdateCompany RPC.
	CompanyServiceUpdateCompanyProcedure = "/koloney.v1.company.CompanyService/UpdateCompany"
	// CompanyServiceDeleteCompanyProcedure is the fully-qualified name of the CompanyService's
	// DeleteCompany RPC.
	CompanyServiceDeleteCompanyProcedure = "/koloney.v1.company.CompanyService/DeleteCompany"
	// CompanyServiceListCompaniesProcedure is the fully-qualified name of the CompanyService's
	// ListCompanies RPC.
	CompanyServiceListCompaniesProcedure = "/koloney.v1.company.CompanyService/ListCompanies"
	// CompanyServiceSearchCompaniesProcedure is the fully-qualified name of the CompanyService's
	// SearchCompanies RPC.
	CompanyServiceSearchCompaniesProcedure = "/koloney.v1.company.CompanyService/SearchCompanies"
	// CompanyServiceUpdateCompanyStatusProcedure is the fully-qualified name of the CompanyService's
	// UpdateCompanyStatus RPC.
	CompanyServiceUpdateCompanyStatusProcedure = "/koloney.v1.company.CompanyService/UpdateCompanyStatus"
	// CompanyServiceVerifyCompanyProcedure is the fully-qualified name of the CompanyService's
	// VerifyCompany RPC.
	CompanyServiceVerifyCompanyProcedure = "/koloney.v1.company.CompanyService/VerifyCompany"
)

// CompanyServiceClient is a client for the koloney.v1.company.CompanyService service.
...
// NewCompanyServiceClient constructs a client for the koloney.v1.company.CompanyService service. By
...
// CreateCompany calls koloney.v1.company.CompanyService.CreateCompany.
...
// GetCompany calls koloney.v1.company.CompanyService.GetCompany.
...
// UpdateCompany calls koloney.v1.company.CompanyService.UpdateCompany.
...
// DeleteCompany calls koloney.v1.company.CompanyService.DeleteCompany.
...
// ListCompanies calls koloney.v1.company.CompanyService.ListCompanies.
...
// SearchCompanies calls koloney.v1.company.CompanyService.SearchCompanies.
...
// UpdateCompanyStatus calls koloney.v1.company.CompanyService.UpdateCompanyStatus.
...
// VerifyCompany calls koloney.v1.company.CompanyService.VerifyCompany.
...
// CompanyServiceHandler is an implementation of the koloney.v1.company.CompanyService service.
...
func NewCompanyServiceHandler(svc CompanyServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.v1.company.CompanyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCompanyServiceHandler) CreateCompany(context.Context, *connect_go.Request[company.CreateCompanyRequest]) (*connect_go.Response[company.Company], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.CreateCompany is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) GetCompany(context.Context, *connect_go.Request[company.GetCompanyRequest]) (*connect_go.Response[company.Company], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.GetCompany is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) UpdateCompany(context.Context, *connect_go.Request[company.UpdateCompanyRequest]) (*connect_go.Response[company.Company], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.UpdateCompany is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) DeleteCompany(context.Context, *connect_go.Request[company.DeleteCompanyRequest]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.DeleteCompany is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) ListCompanies(context.Context, *connect_go.Request[company.ListCompaniesRequest]) (*connect_go.Response[company.ListCompaniesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.ListCompanies is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) SearchCompanies(context.Context, *connect_go.Request[company.SearchCompaniesRequest]) (*connect_go.Response[company.SearchCompaniesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.SearchCompanies is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) UpdateCompanyStatus(context.Context, *connect_go.Request[company.UpdateCompanyStatusRequest]) (*connect_go.Response[company.Company], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.UpdateCompanyStatus is not implemented"))
}
...
func (UnimplementedCompanyServiceHandler) VerifyCompany(context.Context, *connect_go.Request[company.VerifyCompanyRequest]) (*connect_go.Response[company.Company], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.company.CompanyService.VerifyCompany is not implemented"))
}
