...
import (
	...
	application "koloney-protos/go/v1/v1/application"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ApplicationServiceName = "koloney.v1.application.ApplicationService"
)
...
const (
	...
	ApplicationServiceCreateApplicationProcedure = "/koloney.v1.application.ApplicationService/CreateApplication"
	// ApplicationServiceGetApplicationProcedure is the fully-qualified name of the ApplicationService's
	// GetApplication RPC.
	ApplicationServiceGetApplicationProcedure = "/koloney.v1.application.ApplicationService/GetApplication"
	...
	ApplicationServiceUpdateApplicationProcedure = "/koloney.v1.application.ApplicationService/UpdateApplication"
	...
	ApplicationServiceDeleteApplicationProcedure = "/koloney.v1.application.ApplicationService/DeleteApplication"
	// ApplicationServiceListApplicationsProcedure is the fully-qualified name of the
	// ApplicationService's ListApplications RPC.
	ApplicationServiceListApplicationsProcedure = "/koloney.v1.application.ApplicationService/ListApplications"
	...
	ApplicationServiceUpdateApplicationStatusProcedure = "/koloney.v1.application.ApplicationService/UpdateApplicationStatus"
)

// ApplicationServiceClient is a client for the koloney.v1.application.ApplicationService service.
...
// NewApplicationServiceClient constructs a client for the koloney.v1.application.ApplicationService
...
// CreateApplication calls koloney.v1.application.ApplicationService.CreateApplication.
...
// GetApplication calls koloney.v1.application.ApplicationService.GetApplication.
...
// UpdateApplication calls koloney.v1.application.ApplicationService.UpdateApplication.
...
// DeleteApplication calls koloney.v1.application.ApplicationService.DeleteApplication.
...
// ListApplications calls koloney.v1.application.ApplicationService.ListApplications.
...
// UpdateApplicationStatus calls koloney.v1.application.ApplicationService.UpdateApplicationStatus.
...
// ApplicationServiceHandler is an implementation of the koloney.v1.application.ApplicationService
// service.
...
func NewApplicationServiceHandler(svc ApplicationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.v1.application.ApplicationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedApplicationServiceHandler) CreateApplication(context.Context, *connect_go.Request[application.CreateApplicationRequest]) (*connect_go.Response[application.Application], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.CreateApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) GetApplication(context.Context, *connect_go.Request[application.GetApplicationRequest]) (*connect_go.Response[application.Application], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.GetApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) UpdateApplication(context.Context, *connect_go.Request[application.UpdateApplicationRequest]) (*connect_go.Response[application.Application], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.UpdateApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) DeleteApplication(context.Context, *connect_go.Request[application.DeleteApplicationRequest]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.DeleteApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) ListApplications(context.Context, *connect_go.Request[application.ListApplicationsRequest]) (*connect_go.Response[application.ListApplicationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.ListApplications is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) UpdateApplicationStatus(context.Context, *connect_go.Request[application.UpdateApplicationStatusRequest]) (*connect_go.Response[application.Application], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.application.ApplicationService.UpdateApplicationStatus is not implemented"))
}
