...
import (
	...
	job "koloney-protos/go/v1/v1/job"
	http "net/http"
	strings "strings"
)
...
const (
	...
	JobServiceName = "koloney.v1.job.JobService"
)
...
// NewJobServiceClient constructs a client for the koloney.v1.job.JobService service. By default, it
...
// CreateJob calls koloney.v1.job.JobService.CreateJob.
...
// GetJob calls koloney.v1.job.JobService.GetJob.
...
// UpdateJob calls koloney.v1.job.JobService.UpdateJob.
...
// DeleteJob calls koloney.v1.job.JobService.DeleteJob.
...
// ListJobs calls koloney.v1.job.JobService.ListJobs.
...
// SearchJobs calls koloney.v1.job.JobService.SearchJobs.
...
// UpdateJobStatus calls koloney.v1.job.JobService.UpdateJobStatus.
...
// JobServiceHandler is an implementation of the koloney.v1.job.JobService service.
...
func NewJobServiceHandler(svc JobServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/koloney.v1.job.JobService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedJobServiceHandler) CreateJob(context.Context, *connect_go.Request[job.CreateJobRequest]) (*connect_go.Response[job.Job], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.CreateJob is not implemented"))
}
...
func (UnimplementedJobServiceHandler) GetJob(context.Context, *connect_go.Request[job.GetJobRequest]) (*connect_go.Response[job.Job], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.GetJob is not implemented"))
}
...
func (UnimplementedJobServiceHandler) UpdateJob(context.Context, *connect_go.Request[job.UpdateJobRequest]) (*connect_go.Response[job.Job], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.UpdateJob is not implemented"))
}
...
func (UnimplementedJobServiceHandler) DeleteJob(context.Context, *connect_go.Request[job.DeleteJobRequest]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.DeleteJob is not implemented"))
}
...
func (UnimplementedJobServiceHandler) ListJobs(context.Context, *connect_go.Request[job.ListJobsRequest]) (*connect_go.Response[job.ListJobsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.ListJobs is not implemented"))
}
...
func (UnimplementedJobServiceHandler) SearchJobs(context.Context, *connect_go.Request[job.SearchJobsRequest]) (*connect_go.Response[job.SearchJobsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.SearchJobs is not implemented"))
}
...
func (UnimplementedJobServiceHandler) UpdateJobStatus(context.Context, *connect_go.Request[job.UpdateJobStatusRequest]) (*connect_go.Response[job.Job], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("koloney.v1.job.JobService.UpdateJobStatus is not implemented"))
}
